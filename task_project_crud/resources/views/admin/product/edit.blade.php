                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-lg-6">
                      ...
                      <select class="form-control" name="category_id" id="category_id">
                        ...
                        @foreach($category as $row)
                           {{-- @php 
                              $subcategory=DB::table('subcatagories')->where('Catagory_id',$row->id)->get();
                           @endphp --}}
                           <option style="color:blue;" value="{{ $row->id }}" @if($row->id==$product->category_id) selected @endif>{{ $row->Catagory_name }}</option>
                    ...
                    <div class="form-group col-lg-6">
                      ...
                      <select class="form-control" name="subcategory_id" id="subcategory_id">
                         @foreach($subcategory as $child)
                          <option value="{{ $child->id }}"  @if($child->id==$product->subcategory_id) selected @endif>
                            {{ $child->Subcatagory_name }}
                          </option>
                         @endforeach
                      </select>
                    </div>
                  ...
                  <div class="row">
                    <div class="form-group col-lg-6">
                      ...
                      <input type="text" class="form-control @error('color') is-invalid @enderror" value="{{ $product->color }}" data-role="tagsinput" name="color" />
                      @error('color')
                  ...
                  <div class="row">
                    <div class="form-group col-lg-12">
                      ...
                      <textarea class="form-control textarea @error('description') is-invalid @enderror" name="description">{{ $product->description }}</textarea>
                      @error('description')
                      <div class="alert alert-danger">{{ $message }}</div>
                      @enderror
                    </div>
            ...
            <div class="card card-primary">
              <div class="card-body">
                  <div class="form-group">
                    <img src="{{asset('file/product/'.$product->thumbnail)}}" style="height: 50px; width:50px;">
                      ...
                      <tr>  
                          ...
                          <div class="row" >
                           @foreach($images as $key => $image)
                             <div class="col-md-4" >
                                <img alt="" src="{{asset('file/product/'.$image)}}" style="width: 100px; height: 80px; padding: 10px;"/>
