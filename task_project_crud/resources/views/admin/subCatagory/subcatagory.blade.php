    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
              <select name="Catagory_id" id="" class="form-control" required>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('Subcatagory_name') is-invalid @enderror" name="Subcatagory_name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter a Name">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('Subcatagory_name') is-invalid @enderror" name="Subcatagory_name" id="e_subcatagory_name" value =" "
